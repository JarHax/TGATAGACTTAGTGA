...
public class UserDataRecord extends UpdatableRecordImpl<UserDataRecord> implements Record4<Date, Integer, Long, Long> {

    private static final long serialVersionUID = 1570352991;
     ...
     */
    @Override
    public Row4<Date, Integer, Long, Long> fieldsRow() {
     ...
     */
    @Override
    public Row4<Date, Integer, Long, Long> valuesRow() {
     ...
     */
    @Override
    public UserDataRecord value1(Date value) {
        setDate(value);
        return this;
    }
     ...
     */
    @Override
    public UserDataRecord values(Date value1, Integer value2, Long value3, Long value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserDataRecord(Date date, Integer userId, Long pointsTotal, Long workUnitsTotal) {
        super(UserData.USER_DATA);
